...
def create_argparser():
    ...
    parser.add_argument('-z', '--zip', action='store_true', default=False, help='Optional. If you want to archive output data, you may to use this flag.')
        ...
        try:
            ...
            for fd in list_dir:
                try:
                    ...
                    print("Not enough disk space.")
                    print(f"Directory archived {count_zip}, из {list_dir}")
                    exit()
            print(f"Directory archived {count_zip}, из {list_dir}")
        except OSError:
            print("Failed.")
